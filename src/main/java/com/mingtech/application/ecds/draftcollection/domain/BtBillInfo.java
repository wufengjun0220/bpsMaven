 ...
 * @作者：ChenFuLing
 * @日期：Jun 2, 2009 11:49:09 AM
 * @描述：[BtBillInfo]票据信息
 */
public class BtBillInfo implements java.io.Serializable{

	
	private static final long serialVersionUID = 1L;
	
	private String billinfoId;// id
	private String SBillNo; // 票号/票据包号
	...
	private BigDecimal FBillAmount; // 票据(包)金额 
	...
	private String SBanEndrsmtFlag;//不得转让标记
...
//	}
	...
	public String getSBanEndrsmtFlagStr(){
		return DictionaryCache.getCantAttnMarkCnName(this.getSBanEndrsmtFlag());
	}
...
//	}
	...
	public String getSBillTypeName(){
		SBillTypeName = (String) DictionaryCache.getBillType(this.getSBillType());
	...
	public String getSBillMediaName(){
		SBillMediaName = (String) DictionaryCache.getBillMedia(this.getSBillMedia());
	...
	public boolean equals(Object arg0){
		...
		BtBillInfo billInfo = (BtBillInfo) arg0;
...
//	}
	...
	public String getSECDSStatusName(){
		SECDSStatusName = DictionaryCache.getStatusName(this.getSECDSStatus());
	...
	public String getSDealStatusName(){
		SDealStatusName = DictionaryCache.getStatusName(this.getSDealStatus());
...
//		clearingFlagName = (String)DictionaryCache.getSClearWayMap(getClearingFlag());
...
//	}
	...
	public String getOverFlagName() {
		overFlagName = (String)DictionaryCache.getOverFlagTypeMap(this.getOverFlag());
		return overFlagName;
	}
	...
	public String getSSenderMsgStatusName(){
		SSenderMsgStatusName = (String)DictionaryCache.getStatusName(getSSenderMsgStatus());
...
//
	...
	public String getPcdsStatusName(){
		pcdsStatusName = DictionaryCache.getStatusName(this.getPcdsStatus());
...
//	}
	...
	public String getIssuerComScaleName() {
		return issuerComScaleName=DictionaryCache.getPjsCompanySizeNum(this.getIssuerComScale())==null?"":DictionaryCache.getPjsCompanySizeNum(this.getIssuerComScale()).toString();
	}
	...
	public String getIssuerAreaName() {
		return issuerAreaName = (String) DictionaryCache.getPjsAreaName(this.getIssuerArea());
