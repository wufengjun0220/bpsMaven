 ...
 *
 */
public class PedProtocolModDto implements java.io.Serializable{
	...
	private String xyflag;// 是否自动续约（00：否 ，01：是）
	private String xyflagName;// 界面显示字段映射：是否自动续约（00：否 ，01：是）
	...
	/*public String getOfficeNetName() {
		officeNetName = (String) DictionaryCache.getOfficeNetName(this.getOfficeNet());
