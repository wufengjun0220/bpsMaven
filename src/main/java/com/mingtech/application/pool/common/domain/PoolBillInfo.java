 ...
 * @描述：[PoolBillInfo]票据信息
 */
public class PoolBillInfo implements java.io.Serializable{
...
//	private String buyCostRateType;//买入成本利率类型
	...
	private String SPayeeAcctName;// 收款人账号名称
	private String SAcceptorAcctName; // 承兑人账号名称
	private String tranRpiorName; // 直接前手名称
	...
	public void setSPayeeAcctName(String sPayeeAcctName) {
		SPayeeAcctName = sPayeeAcctName;
	}

	public String getSAcceptorAcctName() {
		return SAcceptorAcctName;
	}

	public void setSAcceptorAcctName(String sAcceptorAcctName) {
		SAcceptorAcctName = sAcceptorAcctName;
	}

	public String getTranRpiorName() {
		return tranRpiorName;
	}

	public void setTranRpiorName(String tranRpiorName) {
		this.tranRpiorName = tranRpiorName;
	}
