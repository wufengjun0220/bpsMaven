...
public class PlCrdtPayCachePlan implements java.io.Serializable {
	...
	private String isLocal;       //是否跨行 0：他行1：本行
	private BigDecimal totalAmt;  //总金额
	private BigDecimal usedAmt;   //已支付金额
	private BigDecimal repayAmt;  //剩余支付金额
