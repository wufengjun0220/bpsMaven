...
public class PlOnlineAcptBatch implements java.io.Serializable {
	...
	private String dealStatus;    //业务处理状态   DS001未处理  DS002处理中  DS003处理完成  DS004已撤销  DS005失败
	...
	private Date taskDate;//调度任务操作时间
	
	private BigDecimal oriContractAmt;              //原合同金额
	// Constructors

	/** default constructor */
	public PlOnlineAcptBatch() {
	}
