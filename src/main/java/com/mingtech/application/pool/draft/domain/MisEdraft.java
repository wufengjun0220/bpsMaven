...
/**
 * MisEdraft entity. @author MyEclipse Persistence Tools
 */

public class MisEdraft implements java.io.Serializable {
	...
	/** full constructor */
	public MisEdraft(String custNo, String custName, String assetType,
