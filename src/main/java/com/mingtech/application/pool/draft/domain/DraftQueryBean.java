...
public class DraftQueryBean{
	
	@DateTimeFormat(pattern="yyyy-MM-dd")
	private Date startplDueDt;// 到期日
	@DateTimeFormat(pattern="yyyy-MM-dd")
	private Date endplDueDt;// 到期日
	private BigDecimal startplIsseAmt;// 票据金额
	private BigDecimal endplIsseAmt;// 票据金额
	...
	private String plAccptrSvcr;// 承兑人开户行行号/承兑行
	
	@DateTimeFormat(pattern="yyyy-MM-dd")
	private Date plIsseDt;// 出票日
	@DateTimeFormat(pattern="yyyy-MM-dd")
	private Date startplIsseDt;// 出票日开始
	@DateTimeFormat(pattern="yyyy-MM-dd")
	private Date endplIsseDt;// 出票日结束
	...
	private String payType;//票据权益
	private String custNo;//客户号
	private String custName;//票据池客户名称
	private String busiId;
	
	private List<String> list;//通用传值List
	...
	public Date getStartplIsseDt() {
		return startplIsseDt;
	}
	public void setStartplIsseDt(Date startplIsseDt) {
		this.startplIsseDt = startplIsseDt;
	}
	public Date getEndplIsseDt() {
		return endplIsseDt;
	}
	public void setEndplIsseDt(Date endplIsseDt) {
		this.endplIsseDt = endplIsseDt;
	}
	...
	public String getRickLevelName() {
		String name = "";
		if("FX_01".equals(this.getRickLevel())){
			name="低风险额度";
		}else if("FX_02".equals(this.getRickLevel())){
			name="高风险额度";
		}else if("FX_03".equals(this.getRickLevel())){
			name="不在风险名单";
		}
		return name;
	}
