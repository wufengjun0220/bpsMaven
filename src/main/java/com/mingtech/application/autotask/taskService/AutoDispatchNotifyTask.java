...
/**
 * 调度异常的任务自动唤醒处理：
 * 	（1）执行设置：8.30-19：30执行 ，每半小时一次，可执行4次，2小时前的任务不再处理，
 ...
 */
public class AutoDispatchNotifyTask  extends AbstractAutoTask {
	private static final Logger logger = Logger.getLogger(AutoDispatchNotifyTask.class);
	...
	public BooleanAutoTaskResult run() throws Exception {
		...
		String hour    = SystemConfigCache.getSystemConfigItemByCode(SystemConfigCache.OL_LIMIT_TIME    );//在线业务异常轮训处理时间 2小时
